                    ...
                    <div class="card-body p-0">
                        <div class="row">
                            <div class="col-lg-6 d-none d-lg-flex">
                                <div class="flex-grow-1 bg-login-image" style="background-image: url(&quot;assets/img/dogs/image31.jpeg&quot;);"></div>
                            </div>
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form class="user" method="post" action="login.php" autocomplete="off">
                                        <div class="form-group">
                                            <input class="form-control form-control-user" type="text=" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Enter UserName..." name="username"></div>
                                        <div class="form-group">
